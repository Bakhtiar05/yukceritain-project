...
import { CreateStoryDrawerProvider } from '@/components/community/CreateStoryDrawerProvider'
import CreateStoryDrawer from '@/components/community/CreateStoryDrawer'
          ...
          <CommentSheetProvider>
            ...
            <div className="min-h-screen bg-background flex justify-center font-sans text-foreground selection:bg-blue-100 dark:selection:bg-blue-900 selection:text-blue-900 dark:selection:text-blue-100 transition-colors duration-300">
              <div className="w-full max-w-[1600px] flex flex-col md:flex-row md:px-4 xl:px-8 gap-6 xl:gap-8">
                ...
                {/* Main Feed Column */}
                <div className="flex-1 w-full max-w-[600px] mx-auto min-h-screen flex flex-col bg-card md:bg-transparent md:dark:bg-transparent md:rounded-3xl my-0 md:my-4 relative transition-colors duration-300">
            ...
            <CreateStoryDrawer isAuthenticated={isAuthenticated} />
          </CommentSheetProvider>
        </CreateStoryDrawerProvider>
      </AuthModalProvider>
    </CommunityLanguageProvider>

  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-2xl mx-auto w-full">
      <div className="text-center mb-8">
        ...
        <p className="text-sm md:text-base text-slate-500 dark:text-muted-foreground max-w-md mx-auto leading-relaxed">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
        <button
          ...
          className={`relative text-left p-5 rounded-2xl border-2 transition-all duration-300 ${
            counselorPreference === "auto"
              ...
              : "border-slate-100 dark:border-border bg-white dark:bg-card hover:border-slate-300 dark:hover:border-slate-600 hover:shadow-sm"
          }`}
        >
          {counselorPreference === "auto" && (
          ...
          <h3 className="font-bold text-slate-900 dark:text-foreground mb-1 pr-6">Pilihkan untuk Saya</h3>
          <p className="text-sm text-slate-500 dark:text-muted-foreground">Sistem akan mencarikan konselor profesional yang paling sesuai dan tersedia.</p>
        </button>
        ...
        >
          ...
          <h3 className="font-bold text-slate-900 dark:text-foreground mb-1 pr-6">Pilih Konselor Sendiri</h3>
          <p className="text-sm text-slate-500 dark:text-muted-foreground">Lihat profil dan pilih konselor secara langsung.</p>
        </button>
      </div>
                ...
                <div
                  ...
                  className={`relative cursor-pointer rounded-2xl p-4 border-2 transition-all duration-300 ${
                    isSelected 
                      ...
                      : "border-slate-100 dark:border-border bg-white dark:bg-card hover:border-slate-300 dark:hover:border-slate-600"
                  }`}
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="font-bold text-slate-900 dark:text-foreground leading-tight">{counselor.full_name}</h3>
                      <p className="text-sm text-slate-500 dark:text-muted-foreground mt-0.5">{counselor.profession}</p>
                    </div>
                    {isSelected && (

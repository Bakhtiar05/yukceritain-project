    ...
    <section className="py-12 md:py-20 bg-slate-50 dark:bg-background relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-8 md:mb-16">
          ...
          <p className="text-lg text-slate-600 dark:text-muted-foreground mb-6 md:mb-0">
        ...
        <div className="flex overflow-x-auto snap-x snap-mandatory hide-scrollbar gap-4 pb-8 -mx-6 px-6 md:mx-0 md:px-0 md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-8">
          {counselors.map((counselor) => (
            <div key={counselor.id} className="w-[75vw] max-w-[260px] shrink-0 snap-center md:w-auto bg-white dark:bg-card rounded-3xl p-5 md:p-6 shadow-sm border border-blue-200 hover:border-blue-400 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              ...
              <div className="bg-slate-50 dark:bg-white/5 rounded-xl p-3 mb-6 text-center">
                <p className="text-xs text-slate-500 dark:text-muted-foreground uppercase font-bold tracking-wider mb-1">Experience</p>
                <p className="font-semibold text-slate-900 dark:text-foreground text-sm md:text-base">{counselor.experience_years} Years</p>
              </div>

              <p className="text-slate-600 dark:text-muted-foreground text-sm text-center mb-6 line-clamp-2">
                {counselor.short_bio}
              </p>

  ...
  return (
    <div className="pt-1 px-4 md:px-0 mb-5">
      <Link 
        ...
        className="relative flex items-center gap-3 sm:gap-4 bg-[#F4F9FF] dark:bg-slate-800/40 rounded-[32px] border border-[#E5F0FF] dark:border-slate-700/60 p-2.5 sm:p-3 cursor-pointer transition-all duration-200 ease-out hover:scale-[1.015] hover:border-[#CFE4FF] dark:hover:border-slate-600 hover:shadow-sm active:scale-[0.98] group"
      >
